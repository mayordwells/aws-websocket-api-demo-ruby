...
```bash
hello-ruby-sam$ sam logs -n StockCheckerFunction --stack-name hello-ruby-sam --tail
```
...
```bash
hello-ruby-sam$ ruby tests/unit/test_stock_checker.rb
```
...
```bash
aws cloudformation delete-stack --stack-name hello-ruby-sam
```
